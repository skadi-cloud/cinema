...
sed -i 's+\${MAIN_CLASS}+\"-Dorg.jetbrains.projector.server.classToLaunch=jetbrains.mps.Launcher\" org.jetbrains.projector.server.ProjectorLauncher+g' "$IDE_RUN_FILE_NAME-projector.sh"
